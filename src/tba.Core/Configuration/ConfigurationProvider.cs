...
{
    /// <summary>
    /// A configuration provider that reads sections from a web.config or app.config file.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class ConfigurationProvider<T> : IConfigurationProvider<T> where T : ConfigurationSection
    {
        /// <summary>
